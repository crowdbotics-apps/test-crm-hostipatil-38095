...
## Project Structure
    ...
    ├── test_crm_hostipatil_38095  # Django project configurations
...
1. Clone this repo and `cd test_crm_hostipatil_38095`
...
2. Clone this repo and `cd test_crm_hostipatil_38095`
